 ...
 * @author mon
 */
public class AddRestauController implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) {
        if ((event.getSource() == btn_feed)) {
            try {
                javafx.scene.Parent tableview = FXMLLoader.load(getClass().getResource("AffichRestau.fxml"));
    ...
    private void ajouter(ActionEvent event) throws IOException, SQLException {
       ...
       Restaurant t = new  Restaurant(Titre, Type,Description);
       RestaurantService ms = new RestaurantService();
        ms.ajouterFeed(t);
    ...
    private void logoutClicked(ActionEvent event) {
        ...
        if (result.get() == ButtonType.YES) {
            try {
                ...
                Logger.getLogger(AddRestauController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
