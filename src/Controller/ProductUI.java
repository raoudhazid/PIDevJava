...
public class ProductUI implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        List<productFile> lss=new ArrayList<productFile>();
        ...
        try {
            ...
            try {
                for (int i = 0; i < ls.size(); i++) {
                    ...
                    fxmlLoader.setLocation(getClass().getResource("/gui/itemProduct.fxml"));
                    HBox cardBox = fxmlLoader.load();
                    Controller.ItemProduct itemControllor = fxmlLoader.getController();
    ...
    public void btnHome (ActionEvent event) {
        playMusic("C:\\Users\\Mohamed\\pidevjava\\src\\resources\\Sound.wav");
